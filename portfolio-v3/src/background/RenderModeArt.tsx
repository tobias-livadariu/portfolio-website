...
/* Outer Wilds vault locks: the number of petals is the mode index, so the
   ...
   renderer — so these are glyphs too rather than smooth CSS shapes.
   Regenerate with scripts/generate-vault-sigils.mjs. */
